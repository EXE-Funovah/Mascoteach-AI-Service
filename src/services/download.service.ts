...
/** Download a file from a URL and save it to uploads/ */
    ...
    return new Promise((resolve, reject) => {
        ...
        protocol.get(fileUrl, (response) => {
            ...
            fileStream.on("finish", () => {
                fileStream.close();
                resolve({ filePath, mimeType: contentType, fileName: rawName });
            });
            ...
            reject(new Error(`Cannot download file: ${err.message}`));
        });
    });
}
